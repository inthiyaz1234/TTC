    ...
    <div class="hero-grid">
      ...
      <div class="hero-content">
        <div class="hero-glass-card">
          ...
          <div class="hero-btns mobile-cta">
            <a href="{{ route('boc.step1', ['source' => 'taxexpert-nehakulkarni']) }}" class="btn btn-primary">
              Book Consultation
            </a>
      ...
      <div class="hero-photo-wrap">
        ...
        <div class="hero-photo-card" id="heroPhotoCard">
          <img class="hero-avatar" src="{{ asset('images/taxexperts/neha-kulkarni.jpg') }}" alt="Neha Kulkarni - Tax & Compliance Expert" loading="eager">
        </div>
    ...
    <div class="expertise-grid reveal-stagger" style="margin-top:32px">
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          <div class="exp-icon">
            <svg viewBox="0 0 24 24"><path d="M6 2h9l5 5v15a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2z"/><polyline points="14 2 14 8 20 8"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="16" y2="17"/></svg>
          </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          <div class="exp-icon">
            <svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><circle cx="12" cy="16" r="1"/></svg>
          </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          <div class="exp-icon">
            <svg viewBox="0 0 24 24"><polyline points="4 14 10 8 14 12 20 6"/><line x1="4" y1="20" x2="20" y2="20"/></svg>
          </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          <div class="exp-icon">
            <svg viewBox="0 0 24 24"><rect x="3" y="10" width="4" height="10"/><rect x="10" y="6" width="4" height="14"/><rect x="17" y="3" width="4" height="17"/></svg>
          </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          <div class="exp-icon">
            <svg viewBox="0 0 24 24"><path d="M12 1l9 4v6c0 5-3.8 9.7-9 11-5.2-1.3-9-6-9-11V5l9-4z"/><polyline points="9 12 11 14 15 10"/></svg>
          </div>
  ...
  <div class="wrap">
    ...
    <div class="industry-grid reveal-stagger">
      ...
      <div class="ind-card">
        ...
        <div class="ind-desc">Employees with salary + other income. Maximize refund and plan deductions smartly.</div>
      </div>

      <div class="ind-card">
        <div class="ind-icon-wrap">
          <svg viewBox="0 0 24 24" width="28" height="28" stroke="#fff" fill="none" stroke-width="1.5">
            <rect x="3" y="4" width="18" height="12" rx="2"/><path d="M8 20h8"/>
          </svg>
        </div>
        <div class="ind-title">Professionals</div>
        <div class="ind-desc">Doctors, consultants, freelancers with variable income. Proper ITR filing and advance tax management.</div>
      </div>
      ...
      <div class="ind-card">
        ...
        <div class="ind-desc">Small and medium businesses needing GST filing, bookkeeping, and complete tax compliance.</div>
      </div>
...
<section id="dark-minimal-cta" style="background-color: #000000; padding: 80px 0; border-top: 1px solid #1a1a1a; border-bottom: 1px solid #1a1a1a; text-align: center; font-family: -apple-system, BlinkMacSystemFont, 'Helvetica Neue', Arial, sans-serif; overflow: hidden;">
  ...
  <div class="expert-cta-container">
    ...
    <h2 class="expert-cta-heading reveal-elem delay-1">
      Ready to simplify<br><span class="highlight">your taxes?</span>
    </h2>

    <p class="expert-cta-subtext reveal-elem delay-2">
      Whether you're a salaried individual, professional, or growing business — Tax expert <strong>Neha Kulkarni</strong> is here to help.
    </p>

    <div class="reveal-elem delay-3" style="display: flex; justify-content: center;">
      <a href="{{ route('boc.step1', ['source' => 'taxexpert-nehakulkarni-cta']) }}" class="expert-cta-btn">
        Hire Our Tax Expert
