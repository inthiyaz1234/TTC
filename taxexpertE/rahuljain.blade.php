...
<title>Rahul Jain | Compliance & Audit Tax Expert | ROC Filing Expert India</title>
    ...
    <div class="hero-grid">
      ...
      <div class="hero-content">
        <div class="hero-glass-card">
          ...
          <div class="hero-badge-wrap">
            <div class="badge">
              ...
              <span>Compliance Specialist &bull; 200+ Clients Served</span>
            </div>
          </div>

          <!-- Name -->
          <div class="hero-name">Rahul<br>Jain</div>
          ...
          <div class="hero-bio-pill">
            Specializes in compliance, ROC filings, and audit support for companies and businesses to ensure zero-penalty operations.
          </div>

          <!-- Buttons -->
          <div class="hero-btns mobile-cta">
            <a href="{{ route('boc.step1', ['source' => 'taxexpert-rahuljain']) }}" class="btn btn-primary">
              Book Consultation
            </a>
        ...
        <div class="info-strip">
          <div class="info-strip-row">
            ...
            <div class="info-cell"><div class="info-cell-icon"><svg viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg></div><div class="info-cell-label">Experience</div><div class="info-cell-value">3+ Years</div></div>
      ...
      <div class="hero-photo-wrap">
        ...
        <div class="hero-metric metric-2">
          <div class="hero-metric-val"><span class="kpi-hero" data-target="3">0</span>+ Yrs</div>
          <div class="hero-metric-lbl">Experience</div>
        </div>
        <div class="hero-photo-card" id="heroPhotoCard">
          <img class="hero-avatar" src="{{ asset('images/taxexperts/rahul-jain.jpg') }}" alt="Rahul Jain - Compliance & Audit Tax Expert" loading="eager">
        </div>
        <div class="hero-trust">
          ...
          Compliance Specialist &bull; Verified Professional
        </div>
      </div>
...
<section class="sec reveal-section" id="expertise">
  <div class="wrap">
    ...
    <p class="sec-sub">Specialized compliance, ROC filing, and audit solutions designed to keep your business fully compliant and penalty-free.</p>
    <div class="expertise-grid reveal-stagger" style="margin-top:32px">

      <div class="exp-card tap-card">
        <div class="card-front">
          <div class="exp-icon"><svg viewBox="0 0 24 24"><path d="M6 2h9l5 5v15H6z"/><path d="M14 2v6h6"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="13" y2="17"/></svg></div>
          <div class="exp-title">ROC Filing</div>
          <div class="exp-desc">Accurate ROC filings including annual returns, MCA submissions, and company compliance.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">ROC Filing</div>
          <div class="card-back-desc">Complete ROC compliance and filings handled accurately and on time.</div>
        </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          ...
          <div class="exp-title">Compliance Management</div>
          <div class="exp-desc">End-to-end compliance tracking and filings for businesses.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Compliance Management</div>
          <div class="card-back-desc">Ongoing compliance support ensuring zero penalties.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          <div class="exp-icon"><svg viewBox="0 0 24 24"><circle cx="11" cy="11" r="7"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg></div>
          <div class="exp-title">Audit Support</div>
          <div class="exp-desc">Professional audit including documentation, checks, and reporting.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Audit Support</div>
          <div class="card-back-desc">Complete audit readiness and compliance documentation support.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          <div class="exp-icon"><svg viewBox="0 0 24 24"><path d="M3 21h18"/><path d="M6 18V9"/><path d="M10 18V9"/><path d="M14 18V9"/><path d="M18 18V9"/><path d="M4 9h16"/><path d="M12 3l8 6H4z"/></svg></div>
          <div class="exp-title">Company Law Advisory</div>
          <div class="exp-desc">Expert guidance on company law, filings, and regulatory requirements.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Company Law</div>
          <div class="card-back-desc">Advisory on company law and regulatory compliance matters.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          <div class="exp-icon"><svg viewBox="0 0 24 24"><path d="M8 6h13"/><path d="M8 12h13"/><path d="M8 18h13"/><path d="M3 6h.01"/><path d="M3 12h.01"/><path d="M3 18h.01"/></svg></div>
          <div class="exp-title">Annual Filings</div>
          <div class="exp-desc">Preparation and filing of annual returns and financial statements.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Annual Filings</div>
          <div class="card-back-desc">Accurate annual return filing and financial reporting compliance.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          <div class="exp-icon"><svg viewBox="0 0 24 24"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M9 12l2 2 4-4"/></svg></div>
          <div class="exp-title">Regulatory Compliance</div>
          <div class="exp-desc">Ensuring businesses meet all statutory requirements without delays.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Regulatory Compliance</div>
          <div class="card-back-desc">Complete compliance management for smooth and penalty-free operations.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
...
<section class="sec reveal-section">
  <div class="wrap">
    ...
    <p class="sec-sub">Compliance and audit solutions tailored for companies, startups, and growing businesses.</p>
    <div class="industry-grid reveal-stagger">
      ...
      <div class="ind-card tap-card">
        <div class="card-front">
          ...
          <div class="ind-title">Corporates</div>
          <div class="ind-desc">Large companies requiring structured compliance, ROC filings, and audit support.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Corporates</div>
          <div class="card-back-desc">End-to-end compliance and audit solutions for corporate entities.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="ind-card tap-card">
        <div class="card-front">
          <div class="ind-icon-wrap"><svg viewBox="0 0 24 24" width="28" height="28" stroke="#fff" fill="none" stroke-width="1.5"><path d="M3 21h18"/><path d="M6 18V9"/><path d="M10 18V9"/><path d="M14 18V9"/><path d="M18 18V9"/><path d="M4 9h16"/></svg></div>
          <div class="ind-title">SMEs</div>
          <div class="ind-desc">Small and medium businesses needing ongoing compliance and filing support.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">SMEs</div>
          <div class="card-back-desc">Compliance management and filings for growing businesses.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="ind-card tap-card">
        <div class="card-front">
          <div class="ind-icon-wrap"><svg viewBox="0 0 24 24" width="28" height="28" stroke="#fff" fill="none" stroke-width="1.5"><path d="M12 2l3 7h7l-5.5 4 2 7-6.5-4.5L5.5 20l2-7L2 9h7z"/></svg></div>
          <div class="ind-title">Startups</div>
          <div class="ind-desc">New businesses requiring compliance setup, ROC filings, and audit readiness.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Startups</div>
          <div class="card-back-desc">Compliance setup and filing support for early-stage companies.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="ind-card tap-card">
        <div class="card-front">
          ...
          <div class="ind-title">Private Limited Companies</div>
          <div class="ind-desc">Companies needing annual filings, ROC compliance, and audit support.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Private Limited</div>
          <div class="card-back-desc">ROC filings, annual compliance, and audit support for companies.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="ind-card tap-card">
        <div class="card-front">
          <div class="ind-icon-wrap"><svg viewBox="0 0 24 24" width="28" height="28" stroke="#fff" fill="none" stroke-width="1.5"><circle cx="12" cy="12" r="10"/><path d="M8 12h8"/><path d="M12 8v8"/></svg></div>
          <div class="ind-title">LLPs</div>
          <div class="ind-desc">Compliance and filing support for Limited Liability Partnerships.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">LLPs</div>
          <div class="card-back-desc">End-to-end compliance and ROC filings for LLPs.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="ind-card tap-card">
        <div class="card-front">
          ...
          <div class="ind-desc">Businesses scaling operations and needing structured compliance systems.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Growing Businesses</div>
          <div class="card-back-desc">Structured compliance and audit systems for scaling businesses.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
...
<section class="sec reveal-section">
  <div class="wrap">
    ...
    <p class="sec-sub">Experience structured compliance and audit readiness with a dedicated professional.</p>
    <div class="values-grid reveal-stagger">
      <div class="val-card"><div class="val-icon"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3"/></svg></div><div class="val-title">Zero Penalties</div><div class="val-desc">Complete compliance management to ensure timely filings and avoid penalties. No regulatory surprises.</div></div>
      <div class="val-card"><div class="val-icon"><svg viewBox="0 0 24 24"><path d="M13 2L3 14h8l-2 8 10-12h-8l2-8z"/></svg></div><div class="val-title">Fast Turnaround</div><div class="val-desc">Efficient processes mean faster filings. Most ROC filings completed within 24–48 hours of receiving complete documents.</div></div>
    ...
    <div class="features-grid reveal-stagger" style="margin-top:0">
      <div class="feat-item"><div class="feat-icon"><svg viewBox="0 0 24 24"><circle cx="12" cy="7" r="4"/><path d="M5.5 21a6.5 6.5 0 0 1 13 0"/><path d="M9 12l2 2 4-4"/></svg></div><div class="feat-text">Compliance Expert</div><div class="feat-sub">Qualified &amp; certified professional</div></div>
...
<section class="cta reveal">
  <div class="wrap">
    <h2>Stay Fully Compliant.<br>Avoid Penalties.</h2>
    <p>Whether you're a corporate, startup, or growing business — Rahul Jain helps you manage ROC filings, compliance, and audits with accuracy and zero delays.</p>
    <div class="cta-btns">
      <a href="{{ route('boc.step1', ['source' => 'taxexpert-rahuljain-cta']) }}" class="btn btn-primary">Book Consultation<svg class="btn-arrow" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
      <a href="#contact" class="btn btn-callback">Request Callback</a>
    </div>
  </div>
</section>
...
<section class="sec reveal-section">
  <div class="wrap">
    ...
    <p class="sec-sub">Common questions about compliance, ROC filings, and audit services with Rahul Jain.</p>
    <div class="card reveal" style="margin-top:28px">
      <div class="faq-item"><div class="faq-q" onclick="toggleFAQ(this)"><span>What documents are required for ROC filing?</span><span class="faq-toggle">+</span></div><div class="faq-a">Typically, you need financial statements, director details, company records, and previous filings. Rahul Jain provides a complete checklist and handles the filing process end-to-end.</div></div>
      <div class="faq-item"><div class="faq-q" onclick="toggleFAQ(this)"><span>How often do companies need to complete compliance filings?</span><span class="faq-toggle">+</span></div><div class="faq-a">Most companies must complete annual ROC filings along with periodic compliance requirements. Rahul ensures all deadlines are met on time to avoid penalties and legal issues.</div></div>
      <div class="faq-item"><div class="faq-q" onclick="toggleFAQ(this)"><span>Can you handle compliance notices and penalties?</span><span class="faq-toggle">+</span></div><div class="faq-a">Yes. Rahul Jain handles compliance notices, responses, and regulatory communication. He reviews the case thoroughly and ensures proper resolution to minimize penalties.</div></div>
      <div class="faq-item"><div class="faq-q" onclick="toggleFAQ(this)"><span>Do you provide services across India?</span><span class="faq-toggle">+</span></div><div class="faq-a">Absolutely. All services are provided online across India. Documents are shared digitally, and consultations are conducted via call or video.</div></div>
      <div class="faq-item"><div class="faq-q" onclick="toggleFAQ(this)"><span>What are your fees for compliance and ROC services?</span><span class="faq-toggle">+</span></div><div class="faq-a">ROC filing starts from ₹1499, and compliance management pricing depends on company size and requirements. Transparent pricing is provided upfront with no hidden charges.</div></div>
      <div class="faq-item"><div class="faq-q" onclick="toggleFAQ(this)"><span>How long does ROC filing or compliance work take?</span><span class="faq-toggle">+</span></div><div class="faq-a">ROC filings are typically completed within 2–5 working days after receiving all documents. Ongoing compliance is managed continuously to ensure timely submissions.</div></div>
    </div>
  </div>
</section>
