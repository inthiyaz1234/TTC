    ...
    <div class="expertise-grid reveal-stagger" style="margin-top:32px">
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          ...
          <div class="exp-desc">
            Pvt Ltd, LLP, OPC, partnership & proprietorship registrations handled end-to-end.
          </div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Business Registration</div>
          <div class="card-back-desc">
            Company, LLP, OPC & proprietorship registrations with full compliance support.
          </div>
        </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          ...
          <div class="exp-desc">
            PAN, TAN, business setup, bank account, and startup advisory services.
          </div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Business Support</div>
          <div class="card-back-desc">
            PAN, TAN, name search, business plans & Virtual CFO support for startups.
          </div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          ...
          <div class="exp-desc">
            ROC filings, annual compliance, and regulatory support for companies & LLPs.
          </div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Compliance Services</div>
          <div class="card-back-desc">
            Company & LLP compliance, ROC filings, and ongoing regulatory support.
          </div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          ...
          <div class="exp-desc">
            Business tax filing, GST returns, and compliance-focused tax solutions.
          </div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Tax Filing</div>
          <div class="card-back-desc">
            Business ITR, GST returns, and structured tax filing for startups.
          </div>
        </div>
        <span class="tap-hint"></span>
      </div>
...
/* ── SERVICE DATA (UPDATED WITH LINKS) ── */
var S = [
...
{n:"MSME Udyam Registration", sf:"Small businesses", el:"MSME eligibility criteria", p:999, m:2000, t:"1 Day", cta:"Register MSME",
link:"https://thetaxcompany.in/servicedetail/msme-udyam-registration"},

{n:"Shop & Establishment License", sf:"Shops & offices", el:"State registration required", p:3999, m:7000, t:"5–10 Working Days", cta:"Apply License",
link:"https://thetaxcompany.in/servicedetail/shop-establishment-license"},

{n:"Import Export Code Registration", sf:"Exporters & traders", el:"Import/export business", p:2499, m:6000, t:"2–3 Working Days", cta:"Get IEC",
link:"https://thetaxcompany.in/servicedetail/import-export-code-registration"},

{n:"Professional Tax Registration", sf:"Employers & professionals", el:"State PT applicable", p:2499, m:5000, t:"3–7 Working Days", cta:"Apply PT",
link:"https://thetaxcompany.in/servicedetail/professional-tax-registration"},

{n:"Digital Signature Certificate", sf:"Businesses & directors", el:"Required for filings", p:2999, m:4000, t:"1 Day", cta:"Get DSC",
link:"https://thetaxcompany.in/servicedetail/digital-signature-certificate"},

{n:"Business PAN Registration", sf:"New businesses", el:"PAN not issued", p:1499, m:3000, t:"3–5 Working Days", cta:"Apply PAN",
link:"https://thetaxcompany.in/servicedetail/business-pan-registration"},

{n:"TAN Registration", sf:"Businesses deducting TDS", el:"TDS applicable", p:1499, m:3000, t:"3–5 Working Days", cta:"Apply TAN",
link:"https://thetaxcompany.in/servicedetail/tan-registration"},

{n:"Current Account Assistance", sf:"Businesses & startups", el:"Bank account needed", p:2499, m:5000, t:"3–7 Working Days", cta:"Open Account",
link:"https://thetaxcompany.in/servicedetail/current-account-assistance"},

{n:"Company Name Search", sf:"Founders & startups", el:"Name availability check", p:1999, m:5000, t:"1–2 Working Days", cta:"Check Name",
link:"https://thetaxcompany.in/servicedetail/company-name-search"},

{n:"Business Plan Preparation", sf:"Startups & founders", el:"Planning or funding stage", p:9999, m:25000, t:"5–7 Working Days", cta:"Create Plan",
link:"https://thetaxcompany.in/servicedetail/business-plan-preparation"},

{n:"Virtual CFO Services", sf:"Growing businesses", el:"Financial advisory needed", p:19999, m:60000, t:"Monthly", cta:"Hire CFO",
link:"https://thetaxcompany.in/servicedetail/virtual-cfo-services"},

{n:"Company Annual Compliance", sf:"Private companies", el:"ROC compliance required", p:9999, m:20000, t:"Yearly", cta:"Stay Compliant",
link:"https://thetaxcompany.in/servicedetail/compliance-services"},
...
<!-- ─── HOW IT WORKS (unchanged content) ─── -->
...
<section class="sec reveal-section">
  <div class="wrap">
    ...
    <div class="industry-grid reveal-stagger">
      ...
      <div class="ind-card tap-card"><div class="card-front"><div class="ind-icon-wrap"><svg viewBox="0 0 24 24" stroke="#fff" fill="none"><path d="M4 21c2-4 6-6 8-6s6 2 8 6"/><circle cx="12" cy="7" r="4"/></svg></div><div class="ind-title">Startups</div><div class="ind-desc">Early-stage businesses looking to register and scale.</div></div><div class="card-back"><div class="card-back-title">Startups</div><div class="card-back-desc">Early-stage businesses looking to register and scale.</div></div><span class="tap-hint"></span></div>
      <div class="ind-card tap-card"><div class="card-front"><div class="ind-icon-wrap"><svg viewBox="0 0 24 24" stroke="#fff" fill="none"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg></div><div class="ind-title">Startups</div><div class="ind-desc">New ventures needing full compliance and legal setup.</div></div><div class="card-back"><div class="card-back-title">Startups</div><div class="card-back-desc">New ventures needing compliance and legal setup.</div></div><span class="tap-hint"></span></div>
      <div class="ind-card tap-card"><div class="card-front"><div class="ind-icon-wrap"><svg viewBox="0 0 24 24" stroke="#fff" fill="none"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg></div><div class="ind-title">Entrepreneurs</div><div class="ind-desc">Individuals launching new ventures and business ideas.</div></div><div class="card-back"><div class="card-back-title">Entrepreneurs</div><div class="card-back-desc">Individuals launching new ventures and business ideas.</div></div><span class="tap-hint"></span></div>
      <div class="ind-card tap-card"><div class="card-front"><div class="ind-icon-wrap"><svg viewBox="0 0 24 24" stroke="#fff" fill="none"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg></div><div class="ind-title">Entrepreneurs</div><div class="ind-desc">Solo founders seeking business structure advisory.</div></div><div class="card-back"><div class="card-back-title">Entrepreneurs</div><div class="card-back-desc">Solo founders seeking business structure advisory.</div></div><span class="tap-hint"></span></div>
      <div class="ind-card tap-card"><div class="card-front"><div class="ind-icon-wrap"><svg viewBox="0 0 24 24" stroke="#fff" fill="none"><path d="M3 3h18v18H3zM8 7h8M8 12h8M8 17h5"/></svg></div><div class="ind-title">Growing Businesses</div><div class="ind-desc">Businesses needing structured compliance and scalability.</div></div><div class="card-back"><div class="card-back-title">Growing Businesses</div><div class="card-back-desc">Businesses needing structured compliance and scalability.</div></div><span class="tap-hint"></span></div>
      <div class="ind-card tap-card"><div class="card-front"><div class="ind-icon-wrap"><svg viewBox="0 0 24 24" stroke="#fff" fill="none"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><path d="M12 22V12"/></svg></div><div class="ind-title">Growing Businesses</div><div class="ind-desc">Enterprises scaling up and requiring advanced support.</div></div><div class="card-back"><div class="card-back-title">Growing Businesses</div><div class="card-back-desc">Enterprises scaling up and requiring advanced support.</div></div><span class="tap-hint"></span></div>
...
<!-- ─── CITIES, VALUES, FEATURES (unchanged) ─── -->
...
<section class="cta reveal">
  <div class="wrap">
    <h2>Build Your Startup<br>the Right Way</h2>
    <p>Helps startups build compliant and scalable foundations.</p>
    <div class="cta-btns">
      <a href="{{ route('boc.step1', ['source' => 'taxexpert-aniktagarwal-cta']) }}" class="btn btn-primary">Book Consultation<svg class="btn-arrow" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
      <a href="#services" class="btn btn-callback">View All Services</a>
    </div>
  </div>
</section>
...
<script>
/* All JavaScript remains identical to original, only FAQ references updated above, no functional changes */
