    ...
    <div class="hero-grid">
      ...
      <div class="hero-content">
        <div class="hero-glass-card">
          ...
          <div class="hero-badge-wrap">
            <div class="badge">
              ...
              <span>Corporate Tax Specialist &bull; 50+ Businesses Served</span>
            </div>
          </div>
          ...
          <div class="hero-bio-pill">
            Focused on corporate taxation, compliance &amp; financial advisory for growing companies. Supports structured and compliant business growth.
          </div>

          <div class="hero-btns mobile-cta">
            <a href="{{ route('boc.step1', ['source' => 'taxexpert-adityaverma']) }}" class="btn btn-primary">
              Book Consultation
            </a>
        ...
        <div class="info-strip">
          <div class="info-strip-row">
            <div class="info-cell"><div class="info-cell-icon"><svg viewBox="0 0 24 24"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg></div><div class="info-cell-label">Clients</div><div class="info-cell-value">50+</div></div>
      ...
      <div class="hero-photo-wrap">
        <div class="hero-metric metric-1">
          <div class="hero-metric-val"><span class="kpi-hero" data-target="50">0</span>+</div>
        ...
        <div class="hero-photo-card" id="heroPhotoCard">
          <img class="hero-avatar" src="{{ asset('images/taxexperts/aditya-varma.jpg') }}" alt="CA Aditya Verma - Corporate Tax Advisor" loading="eager">
        </div>
        <div class="hero-trust">
          ...
          Corporate Tax Specialist &bull; Business Trusted
        </div>
      </div>
    ...
    <div class="expertise-grid reveal-stagger" style="margin-top:32px">
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          ...
          <div class="exp-desc">Corporate and business tax filing including income tax, GST returns, and TDS compliance.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Tax Filing</div>
          <div class="card-back-desc">Business tax, GST &amp; TDS filing for companies.</div>
        </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          ...
          <div class="exp-desc">End-to-end compliance including ROC filings, GST compliance, and statutory business requirements.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Compliance</div>
          <div class="card-back-desc">ROC, GST &amp; regulatory compliance management.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          <div class="exp-icon">
            <svg viewBox="0 0 24 24"><path d="M3 3h18v18H3z"/><line x1="3" y1="9" x2="21" y2="9"/></svg>
          </div>
          <div class="exp-title">Business Registration</div>
          <div class="exp-desc">Company formation services including Pvt Ltd, LLP, and startup registrations.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Registration</div>
          <div class="card-back-desc">Pvt Ltd, LLP &amp; startup registration services.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          <div class="exp-icon">
            <svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M9 12h6"/><path d="M12 9v6"/></svg>
          </div>
          <div class="exp-title">Business Support</div>
          <div class="exp-desc">Strategic advisory including virtual CFO, financial planning, and business growth support.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Advisory</div>
          <div class="card-back-desc">Virtual CFO &amp; business growth advisory.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
...
var S = [
  ...
  {n:"Virtual CFO Services", sf:"Growing businesses", el:"Need financial advisory", p:19999, m:60000, t:"Monthly", cta:"Get CFO",
   link:"https://thetaxcompany.in/servicedetail/virtual-cfo-services",
   cats:['business','tax planning'],
   inc:["Financial strategy","Cash flow planning","Compliance advisory","Reporting","Business insights"],
   exc:["Audit","Litigation","Govt penalties","Third party audit","Legal representation"],
   doc:["Financial data","Bank statements","GST data","Business reports","Management inputs"]},

  {n:"Business Plan Preparation", sf:"Startups & founders", el:"Funding or planning stage", p:9999, m:25000, t:"5–7 Working Days", cta:"Create Plan",
   link:"https://thetaxcompany.in/servicedetail/business-plan-preparation",
   cats:['startups','business','tax planning'],
   inc:["Market research","Financial projections","Business model design","Documentation","Final report"],
   exc:["Funding guarantee","Investor pitching","Legal drafting","Compliance","Third party validation"],
  ...
  <div class="wrap">
    ...
    <div class="industry-grid reveal-stagger">
      ...
      <div class="ind-card">
        ...
        <div class="ind-desc">Early-stage businesses needing company registration, corporate structuring, and compliance setup.</div>
      </div>
      ...
      <div class="ind-card">
        ...
        <div class="ind-desc">Expanding businesses requiring corporate tax filing, ROC compliance, and financial discipline.</div>
      </div>
      ...
      <div class="ind-card">
        ...
        <div class="ind-desc">Businesses needing ongoing compliance, tax optimization, and strategic financial advisory.</div>
      </div>
      ...
      <div class="ind-card">
        ...
        <div class="ind-desc">Large organizations requiring structured compliance, audit readiness, and strategic tax advisory.</div>
      </div>
