...
/* ── SERVICE DATA (UPDATED BUSINESS SERVICES) ── */
var S = [
...
{n:"Company Annual Compliance", sf:"Private companies", el:"ROC compliance required", p:9999, m:20000, t:"Yearly", cta:"Stay Compliant",
 link:"https://thetaxcompany.in/servicedetail/company-annual-compliance", // Note: you may need to adjust if this exact slug exists; based on pattern it's likely
...
<section class="cta reveal">
  <div class="wrap">
    ...
    <div class="cta-btns">
      <a href="{{ route('boc.step1', ['source' => 'taxexpert-adityaverma-cta']) }}" class="btn btn-primary">Book Consultation<svg class="btn-arrow" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
      <a href="#contact" class="btn btn-callback">Request Callback</a>
    </div>
  </div>
</section>
