...
<title>Kavita Gupta | Tax Planning Advisor | Income Tax Advisor India</title>
    ...
    <div class="hero-grid">
        ...
        <div class="hero-glass-card">
          ...
          <div class="hero-badge-wrap">
            <div class="badge">
              ...
              <span>Tax Planning Expert &bull; 500+ Clients Served</span>
            </div>
          </div>

          <!-- Name -->
          <div class="hero-name">Kavita<br>Gupta</div>
          ...
          <div class="hero-bio-pill">
            Focused on strategic tax planning and wealth optimization for individuals and business owners. Helps maximize savings with smart tax strategies.
          </div>

          <!-- Buttons -->
          <div class="hero-btns mobile-cta">
            <a href="{{ route('boc.step1', ['source' => 'taxexpert-kavithaguptha']) }}" class="btn btn-primary">
              Book Consultation
            </a>
      ...
      <div class="hero-photo-wrap">
        ...
        <div class="hero-photo-card" id="heroPhotoCard">
          <img class="hero-avatar" src="{{ asset('images/taxexperts/kavita-gupta.jpg') }}" alt="Kavita Gupta - Tax Planning Advisor" loading="eager">
        </div>
        <div class="hero-trust">
          ...
          Trusted Tax Advisor &bull; Verified Professional
        </div>
      </div>
    ...
    <div class="expertise-grid reveal-stagger" style="margin-top:32px">
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          <div class="exp-icon"><svg viewBox="0 0 24 24"><path d="M12 1v22M17 5H9a4 4 0 0 0 0 8h6a4 4 0 0 1 0 8H7"/></svg></div>
          <div class="exp-title">Tax Planning</div>
          <div class="exp-desc">Strategic tax planning to legally minimize tax liability.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Tax Planning</div>
          <div class="card-back-desc">Strategic tax planning to legally minimize liability.</div>
        </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          ...
          <div class="exp-title">Investment Advisory</div>
          <div class="exp-desc">Guidance on tax-efficient investment strategies.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Investment Advisory</div>
          <div class="card-back-desc">Tax-efficient investment strategies &amp; guidance.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          <div class="exp-icon"><svg viewBox="0 0 24 24"><path d="M14 2H6v20h12V8z"/></svg></div>
          <div class="exp-title">ITR Filing</div>
          <div class="exp-desc">Accurate income tax return filing for individuals and businesses.</div>
        </div>
        <div class="card-back">
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          <div class="exp-icon"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="4"/></svg></div>
          <div class="exp-title">Wealth Optimization</div>
          <div class="exp-desc">Maximizing long-term wealth through tax-efficient planning.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Wealth Optimization</div>
          <div class="card-back-desc">Long-term wealth via tax-efficient planning.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          <div class="exp-icon"><svg viewBox="0 0 24 24"><path d="M12 2l8 4v6c0 5-3.5 9-8 10-4.5-1-8-5-8-10V6z"/></svg></div>
          <div class="exp-title">Tax Saving Strategies</div>
          <div class="exp-desc">Smart deduction planning under 80C, 80D and more.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Tax Saving Strategies</div>
          <div class="card-back-desc">Smart deduction planning under 80C, 80D &amp; more.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          <div class="exp-icon"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M8 12l2 2 4-4"/></svg></div>
          <div class="exp-title">Compliance Advisory</div>
          <div class="exp-desc">Ensuring full compliance with income tax regulations.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Compliance Advisory</div>
          <div class="card-back-desc">Full compliance with income tax regulations.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
...
<section class="sec reveal-section">
  <div class="wrap">
    ...
    <p class="sec-sub">Tailored tax planning and investment solutions for every financial goal.</p>
    <div class="industry-grid reveal-stagger">
      ...
      <div class="ind-card tap-card">
        ...
        <div class="card-back">
          ...
          <div class="card-back-desc">Reduce taxes &amp; increase savings through smart planning.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="ind-card tap-card">
        <div class="card-front">
          <div class="ind-icon-wrap"><svg viewBox="0 0 24 24" width="28" height="28" stroke="#fff" fill="none" stroke-width="1.5"><path d="M12 2l3 7h7l-5.5 4.5L18 21l-6-4-6 4 1.5-7.5L2 9h7z"/></svg></div>
          <div class="ind-title">HNIs</div>
          <div class="ind-desc">High net-worth individuals seeking advanced tax optimization and wealth management.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">HNIs</div>
          <div class="card-back-desc">Advanced tax optimization &amp; wealth management.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="ind-card tap-card">
        ...
        <div class="card-back">
          <div class="card-back-title">Business Owners</div>
          <div class="card-back-desc">Tax optimization &amp; financial structures for business growth.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
...
<section class="sec reveal-section">
  <div class="wrap">
    ...
    <p class="sec-sub">Experience the difference of working with a dedicated, verified tax planning professional.</p>
    <div class="values-grid reveal-stagger">
      <div class="val-card"><div class="val-icon"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3"/></svg></div><div class="val-title">Maximum Savings</div><div class="val-desc">Every filing is optimized to maximize your eligible tax savings. We leave no deduction unclaimed — 80C, 80D, HRA, and beyond.</div></div>
...
<section class="cta reveal">
  <div class="wrap">
    <h2>Save More Tax with<br>Smart Planning</h2>
    <p>Whether you're a salaried professional, HNI, or business owner — Kavita Gupta is here to help you save more tax.</p>
    <div class="cta-btns">
      <a href="{{ route('boc.step1', ['source' => 'taxexpert-kavithaguptha-cta']) }}" class="btn btn-primary">Book Consultation<svg class="btn-arrow" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
      <a href="#contact" class="btn btn-callback">Request Callback</a>
    </div>
  </div>
</section>
...
<section class="sec reveal-section">
  <div class="wrap">
    ...
    <p class="sec-sub">Common questions about working with Kavita Gupta.</p>
    <div class="card reveal" style="margin-top:28px">
      <div class="faq-item"><div class="faq-q" onclick="toggleFAQ(this)"><span>What documents are needed for tax planning?</span><span class="faq-toggle">+</span></div><div class="faq-a">For tax planning: income details, investment proofs (80C, 80D), home loan statements, and capital gains statements. Kavita provides a custom checklist based on your financial situation.</div></div>
      <div class="faq-item"><div class="faq-q" onclick="toggleFAQ(this)"><span>How long does ITR filing take?</span><span class="faq-toggle">+</span></div><div class="faq-a">Most individual ITR filings are completed within 24–48 hours after receiving all required documents. Complex cases involving capital gains or business income may take 3–5 business days.</div></div>
      <div class="faq-item"><div class="faq-q" onclick="toggleFAQ(this)"><span>Do you handle investment advisory?</span><span class="faq-toggle">+</span></div><div class="faq-a">Absolutely. Kavita provides guidance on tax-efficient investment strategies, including ELSS, PPF, NPS, and other options to maximize savings while building wealth.</div></div>
      <div class="faq-item"><div class="faq-q" onclick="toggleFAQ(this)"><span>What about capital gains tax optimization?</span><span class="faq-toggle">+</span></div><div class="faq-a">Kavita provides expert guidance on short-term and long-term capital gains from stocks, mutual funds, property, and other assets — including tax harvesting and exemptions under Sections 54/54F.</div></div>
      <div class="faq-item"><div class="faq-q" onclick="toggleFAQ(this)"><span>What if I receive an income tax notice?</span><span class="faq-toggle">+</span></div><div class="faq-a">Kavita handles all types of income tax notices — scrutiny assessments, demand notices, defective return notices, and more. Share the notice details for a prompt review and response strategy.</div></div>
      <div class="faq-item"><div class="faq-q" onclick="toggleFAQ(this)"><span>What are your fees for tax planning services?</span><span class="faq-toggle">+</span></div><div class="faq-a">Fees are transparent and fixed based on the complexity of your financial situation. Contact Kavita for an exact quote based on your specific requirements — no hidden charges ever.</div></div>
    </div>
  </div>
</section>
