...
<title>Priya Mehta | GST & Compliance Specialist | GST Filing Expert India</title>
<meta name="description" content="Priya Mehta - GST & Compliance Specialist with 3+ years experience in GST filing, notices, ITC optimization and compliance services for businesses across India.">
    ...
    <div class="hero-grid">
        ...
        <div class="hero-glass-card">
          ...
          <div class="hero-badge-wrap">
            <div class="badge">
              ...
              <span>GST & Compliance Specialist &bull; 200+ Businesses Served</span>
            </div>
          </div>

          <!-- Name -->
          <div class="hero-name">Priya<br>Mehta</div>
          ...
          <div class="hero-bio-pill">
            Specialist in GST compliance, return filing, and advisory helping businesses manage indirect taxation efficiently while reducing tax burden and ensuring full compliance.
          </div>

          <!-- Buttons -->
          <div class="hero-btns mobile-cta">
            <a href="{{ route('boc.step1', ['source' => 'taxexpert-priyamehta']) }}" class="btn btn-primary">
              Book Consultation
            </a>
      ...
      <div class="hero-photo-wrap">
        ...
        <div class="hero-photo-card" id="heroPhotoCard">
          <img class="hero-avatar" src="{{ asset('images/taxexperts/priya-mehta.jpg') }}" alt="Priya Mehta - GST & Compliance Specialist" loading="eager">
        </div>
        <div class="hero-trust">
          ...
          GST Specialist &bull; Compliance Expert
        </div>
      </div>
  ...
  <div class="wrap">
    <div class="card about-card">
      ...
      <div class="about-text collapsed" id="aboutText">
        Priya Mehta is a GST and compliance specialist with 3+ years of experience helping businesses manage indirect taxation efficiently. She focuses on accurate GST filings, compliance management, and proactive advisory to avoid penalties.
      </div>
      <div class="about-text expanded" id="aboutFull" style="display:none;">
        Priya Mehta is a detail-oriented GST & Compliance Specialist with over 3 years of experience working with SMEs, e-commerce sellers, and service-based businesses across India. She has assisted 200+ businesses in GST registration, return filing, notice handling, and ITC optimization.<br><br>Her approach focuses on simplifying GST compliance while ensuring businesses maximize eligible tax credits and avoid unnecessary penalties. She provides proactive advisory on GST structuring, helping businesses stay compliant and financially efficient.<br><br>Known for her clarity, responsiveness, and practical solutions, Priya ensures that clients not only stay compliant but also operate with confidence in a complex tax environment.
      </div>
...
<section class="sec reveal-section" id="expertise">
  <div class="wrap">
    ...
    <p class="sec-sub">Specialized GST and compliance solutions designed to keep your business fully compliant and tax-efficient.</p>
    <div class="expertise-grid reveal-stagger" style="margin-top:32px">
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          ...
          <div class="exp-desc">Accurate GST return filing including GSTR-1, GSTR-3B, and annual returns with zero-error compliance.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">GST Filing</div>
          <div class="card-back-desc">Complete GST return filing for businesses — timely, accurate, and penalty-free.</div>
        </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          <div class="exp-icon"><svg viewBox="0 0 24 24"><path d="M12 9v4"/><path d="M12 17h.01"/><path d="M10.29 3.86l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.71-3.14l-8-14a2 2 0 0 0-3.42 0z"/></svg></div>
          <div class="exp-title">GST Notices</div>
          <div class="exp-desc">Professional handling of GST notices, replies, and departmental queries with proper documentation.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">GST Notices</div>
          <div class="card-back-desc">End-to-end notice handling and response filing to avoid penalties and disputes.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          ...
          <div class="exp-desc">Maximize Input Tax Credit while ensuring compliance through proper reconciliation and validation.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">ITC Optimization</div>
          <div class="card-back-desc">Smart ITC strategies to reduce tax liability while staying fully compliant.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          ...
          <div class="exp-desc">Monthly, quarterly, and annual GST compliance management tailored for growing businesses.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">GST Compliance</div>
          <div class="card-back-desc">Complete compliance management to ensure zero penalties and smooth operations.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          ...
          <div class="exp-title">GST Advisory</div>
          <div class="exp-desc">Strategic GST advisory to structure transactions efficiently and reduce overall tax burden.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">GST Advisory</div>
          <div class="card-back-desc">Expert guidance on GST planning, structuring, and compliance strategies.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
...
<section class="sec reveal-section" id="services">
  <div class="wrap">
    ...
    <p class="sec-sub">End-to-end GST and compliance services designed for businesses, startups, and professionals.</p>
    <div class="services-clean reveal-stagger">

      <div class="service-main-card tap-card">
        <div class="card-front">
          <div class="service-icon"><svg viewBox="0 0 24 24"><path d="M16 21v-2a4 4 0 0 0-8 0v2"/><circle cx="12" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/></svg></div>
          <div class="service-title">GST Registration</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">GST Registration</div>
          <div class="card-back-desc">Complete GST registration with documentation, application filing. Starts ₹999.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="service-main-card tap-card">
        <div class="card-front">
          ...
          <div class="service-title">GST Returns</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">GST Returns</div>
          <div class="card-back-desc">Monthly & quarterly GST return filing (GSTR-1, GSTR-3B) with reconciliation.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="service-main-card tap-card">
        <div class="card-front">
          ...
          <div class="service-title">Compliance Support</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Compliance Support</div>
          <div class="card-back-desc">Ongoing GST compliance including filings, notices, reconciliation, & advisory support.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
...
<section class="sec reveal-section">
  <div class="wrap">
    ...
    <p class="sec-sub">GST-focused solutions tailored for modern businesses and growing ventures.</p>
    <div class="industry-grid reveal-stagger">

      <div class="ind-card tap-card">
        <div class="card-front">
          <div class="ind-icon-wrap"><svg viewBox="0 0 24 24" width="28" height="28" stroke="#fff" fill="none" stroke-width="1.5"><path d="M6 6h15l-1.5 9h-13z"/><circle cx="9" cy="20" r="1"/><circle cx="18" cy="20" r="1"/><path d="M6 6L5 3H2"/></svg></div>
          <div class="ind-title">E-commerce Sellers</div>
          <div class="ind-desc">Amazon, Flipkart, and D2C brands managing GST returns, TCS reconciliation, and compliance.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">E-commerce Sellers</div>
          <div class="card-back-desc">GST, TCS reconciliation &amp; compliance for online sellers and marketplaces.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="ind-card tap-card">
        <div class="card-front">
          ...
          <div class="ind-desc">Small and medium businesses needing complete GST compliance, filing, and advisory support.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">SMEs</div>
          <div class="card-back-desc">End-to-end GST compliance for growing businesses and enterprises.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="ind-card tap-card">
        <div class="card-front">
          ...
          <div class="ind-title">Service Businesses</div>
          <div class="ind-desc">Consultants, agencies, and professionals managing GST filings and compliance efficiently.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Service Businesses</div>
          <div class="card-back-desc">GST filing &amp; compliance for consultants, agencies &amp; professionals.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="ind-card tap-card">
        <div class="card-front">
          ...
          <div class="ind-desc">Early-stage businesses requiring GST registration, compliance setup, and ongoing advisory.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Startups</div>
          <div class="card-back-desc">GST setup, compliance &amp; advisory for fast-growing startups.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
      ...
      <div class="ind-card tap-card">
        <div class="card-front">
          ...
          <div class="ind-title">Retail & Traders</div>
          <div class="ind-desc">Offline businesses managing billing, GST returns, and compliance across multiple transactions.</div>
        </div>
        <div class="card-back">
          <div class="card-back-title">Retail & Traders</div>
          <div class="card-back-desc">GST compliance for retail shops, wholesalers &amp; traders.</div>
        </div>
        <span class="tap-hint"></span>
      </div>
...
<section class="sec reveal-section">
  <div class="wrap">
    ...
    <p class="sec-sub">Experience reliable and accurate GST compliance with a dedicated specialist.</p>
    ...
    <div class="features-grid reveal-stagger" style="margin-top:0">
      <div class="feat-item"><div class="feat-icon"><svg viewBox="0 0 24 24"><circle cx="12" cy="7" r="4"/><path d="M5.5 21a6.5 6.5 0 0 1 13 0"/><path d="M9 12l2 2 4-4"/></svg></div><div class="feat-text">GST Compliance Expert</div><div class="feat-sub">Qualified &amp; certified professional</div></div>
      <div class="feat-item"><div class="feat-icon"><svg viewBox="0 0 24 24"><path d="M21 15a4 4 0 0 1-4 4H7l-4 3V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4z"/><path d="M7 8h10M7 12h6"/></svg></div><div class="feat-text">Trilingual Support</div><div class="feat-sub">English, Hindi &amp; Gujarati</div></div>
...
<section class="cta reveal">
  <div class="wrap">
    <h2>Simplify Your GST<br>Compliance Today</h2>
    <p>Whether you're an e-commerce seller, SME, or growing business — Priya Mehta helps you stay compliant, avoid penalties, and optimize your GST efficiently.</p>
    <div class="cta-btns">
      <a href="{{ route('boc.step1', ['source' => 'taxexpert-priyamehta-cta']) }}" class="btn btn-primary">Book Consultation<svg class="btn-arrow" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
      <a href="#contact" class="btn btn-callback">Request Callback</a>
    </div>
  </div>
</section>
...
<section class="sec reveal-section">
  <div class="wrap">
    ...
    <p class="sec-sub">Common questions about GST services with Priya Mehta.</p>
    <div class="card reveal" style="margin-top:28px">
      <div class="faq-item"><div class="faq-q" onclick="toggleFAQ(this)"><span>What documents are required for GST registration?</span><span class="faq-toggle">+</span></div><div class="faq-a">You typically need PAN, Aadhaar, business address proof, bank details, and business registration documents (if applicable). Priya Mehta provides a simple checklist and handles the entire process end-to-end.</div></div>
      <div class="faq-item"><div class="faq-q" onclick="toggleFAQ(this)"><span>How often do I need to file GST returns?</span><span class="faq-toggle">+</span></div><div class="faq-a">Most businesses file monthly or quarterly GST returns (GSTR-1, GSTR-3B). The frequency depends on your turnover and scheme. Priya ensures timely filing so you never miss deadlines or incur penalties.</div></div>
      <div class="faq-item"><div class="faq-q" onclick="toggleFAQ(this)"><span>Can you handle GST notices and penalties?</span><span class="faq-toggle">+</span></div><div class="faq-a">Yes. Priya Mehta handles GST notices, replies, and departmental communications. She reviews the notice, prepares accurate responses, and ensures compliance to minimize penalties.</div></div>
