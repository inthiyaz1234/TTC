  ...
  <div class="wrap">
    ...
    <div class="expertise-grid reveal-stagger" style="margin-top:32px">
      ...
      <div class="exp-card tap-card">
        <div class="card-front">
          <div class="exp-icon">
            <svg viewBox="0 0 24 24"><path d="M3 17l6-6 4 4 7-7"/></svg>
          </div>
  ...
  <div class="wrap">
    ...
    <div class="industry-grid reveal-stagger">
      ...
      <div class="ind-card">
        ...
        <div class="ind-desc">Professionals looking for accurate filing and maximum refunds.</div>
      </div>
      ...
      <div class="ind-card">
        ...
        <div class="ind-desc">Non-residents needing compliant tax filing and advisory in India.</div>
      </div>
      ...
      <div class="ind-card">
        ...
        <div class="ind-desc">Individuals with capital gains from stocks, mutual funds, or property.</div>
      </div>
      ...
      <div class="ind-card">
        ...
        <div class="ind-desc">Self-employed individuals needing ITR-4 filing and tax planning.</div>
      </div>
...
<section id="dark-minimal-cta" style="background-color: #000000; padding: 80px 0; border-top: 1px solid #1a1a1a; border-bottom: 1px solid #1a1a1a; text-align: center; font-family: -apple-system, BlinkMacSystemFont, 'Helvetica Neue', Arial, sans-serif; overflow: hidden;">
  ...
  <div class="expert-cta-container">
    ...
    <h2 class="expert-cta-heading reveal-elem delay-1">
      Maximize Your Tax<br><span class="highlight">Refunds Today</span>
    </h2>

    <p class="expert-cta-subtext reveal-elem delay-2">
      Whether you're a salaried individual, NRI, or investor — Tax expert <strong>Sneha Iyer</strong> simplifies tax filing and maximizes refunds.
    </p>

    <div class="reveal-elem delay-3" style="display: flex; justify-content: center;">
      <a href="{{ route('boc.step1', ['source' => 'taxexpert-snehaiyer-cta']) }}" class="expert-cta-btn">
        Hire Our Tax Expert
